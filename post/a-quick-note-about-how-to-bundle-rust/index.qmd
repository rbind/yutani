...
Recently, CRAN published [a document tiled "Using Rust in CRAN packages"][1]
and it refers to my R package, [string2path][2] as an example of bundling 
all the source codes of the dependency Rust crates (Not sure if my name is
...
2. copy the configuration show in the output of `cargo vendor` to 
